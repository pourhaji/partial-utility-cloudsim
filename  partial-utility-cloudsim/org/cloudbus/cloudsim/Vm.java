...
public class Vm {
	...
	/** The VM class of this instance according to Partial Utility. */
	@Deprecated
	private VmClass thisVMClass;
	...
	public Vm(
		...
		setThisVMClass(VmClass.NORMAL);//By default the Vm class is normal.
	}
	...
	/**
	 * Gets the vm class of this instance according to Partial Utility.
	 * 
	 * @return VmClass the vm class of this instance
	 */
	@Deprecated
	...
	/**
	 * Sets the vm class of this instance according to Partial Utility.
	 * 
	 * @param VmClass the class of this instance
	 */
	@Deprecated
	public void setThisVMClass(VmClass thisVMClass) {
		this.thisVMClass = thisVMClass;
	}
